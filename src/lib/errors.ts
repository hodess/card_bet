...
export const SERVER_CODES = [
  ...
  'GAME_NOT_IN_LOBBY', 'GAME_NOT_PLAYING',
  ...
  'UNKNOWN_PACK', 'INVALID_PACK', 'NOT_PACK_OWNER', 'TOO_MANY_PACKS', 'PACK_DELETED',
  'PACK_NOT_OWNED_BY_HOST', 'BOT_LEVEL_INVALID',
  'JOKER_TOO_LATE', 'NOT_FORCED_BIDDER', 'JOKER_ALREADY_USED', 'AUCTION_CLOSED', 'NO_MORE_CARDS',
  // amis
