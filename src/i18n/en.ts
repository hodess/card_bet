...
export const en: Record<string, string> = {
  ...
  'auction.forcedOpening': 'Forced opening',
  'auction.yourOpening': 'Your opening',
  'auction.othersOpening': '{name} is deciding…',
  'auction.opens': 'Opens',
  'auction.awaitingOpen': 'waiting for the opening',
  'auction.openingLine': 'You open this card at {n} €.',
  'auction.openingLineUsed': 'You open this card at {n} € — joker already used.',
  'auction.jokerButton': '★ Use my joker',
  'auction.openingIn': 'Opening in',
  'auction.jokerHint': 'The joker discards the card — nobody buys it — and the opening moves to the next player.',
  'auction.jokerHintUsed': 'Your joker is gone: the opening bid fires automatically when the timer ends.',
  'auction.stampJoker': 'Joker',
  'auction.discarded': 'Card discarded',
  'auction.discardedTo': 'Card discarded · {name} opens next',
  'auction.discardedLegend': 'card discarded',
  'auction.chipJokerAvailable': 'joker available',
  'auction.chipJokerUsed': 'joker used',
  'tier.gold': 'Gold',
  'tier.silver': 'Silver',
  'tier.bronze': 'Bronze',
  ...
  'errors.GAME_NOT_PLAYING': 'This game is not in progress anymore.',
  ...
  'errors.JOKER_TOO_LATE': 'Too late — the auction has started.',
  'errors.NOT_FORCED_BIDDER': 'Only the opening player can discard the card.',
  'errors.JOKER_ALREADY_USED': 'You already played your joker this game.',
  'errors.AUCTION_CLOSED': 'This auction is already closed — the card was sold or discarded.',
  'errors.NO_MORE_CARDS': 'No more cards left to draw.',
